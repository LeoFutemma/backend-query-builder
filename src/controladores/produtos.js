...
const obterProduto = async (req, res) => {
    ...
    try {
        const produto = await knex('produtos').where({ usuario_id: usuario.id, id });
...
const atualizarProduto = async (req, res) => {
    ...
    try {
        ...
        const produtoAtualizado = await knex('produtos').update({ nome, estoque, preco, categoria, descricao, imagem }).where({ id, usuario_id: usuario.id, })
